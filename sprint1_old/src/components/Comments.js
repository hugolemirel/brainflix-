...
<div className="conversationContainer">
    ...
    <div className="innerConvers">
        ...
        <div className="commentCol">
            ...
            <div className="comment">They BLEW the ROOF off at their
    ...
    <div className="innerConvers">
        ...
        <div class="commentCol">
            <div class="commentAuthor">Gary Wong</div>
            <div class="commentDate">12/18/2019</div>
            <div class="comment">Every time I see him shred I feel so
            motivated to get off my couch and
            hop on my board. He’s so talented! I
            wish I can ride like him one day so I
            can really enjoy myself!</div>
         </div>
    </div>
    ...
    <div className="innerConvers">
        ...
        <div class="commentCol">
            <div class="commentAuthor">Theodore Duncan</div>
            <div class="commentDate">12/18/2019</div>
            <div class="comment">How can someone be so good!!!
            You can tell he lives for this and
            loves to do it every day. Everytime I
            see him I feel instantly happy! He’s
            definitely my favorite ever!</div>
        </div>
    </div>
